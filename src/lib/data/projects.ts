...
export const PROJECTS: Project[] = [
  // Residential
  { id:1,  cat:"residential", title:"Mural geometric dormitor",    location:"Timișoara",    area:"14 m²",  duration:"6h",     service:"Wall Print UV",      tags:["Rezidențial","Geometric","Abstract"],     color:"linear-gradient(135deg,#1a0a2a,#2d1045,#1a0a2a)", accent:"#A78BFA", h:280, image:"/assets/portofoliu/mural-geometric-dormitor.png" },
  ...
  // Commercial
  { id:5,  cat:"commercial",  title:"Recepție clinică stomatologică", location:"Timișoara", area:"18 m²",  duration:"1 zi",   service:"Wall Print UV",      tags:["Medical","Recepție","Corporate"],         color:"linear-gradient(135deg,#0a1a10,#0d2518,#0a1a10)", accent:"#22C55E", h:320, image:"/assets/portofoliu/receptie-clinica-stomatologica.png" },
  ...
  { id:10, cat:"commercial",  title:"Cafenea specialty coffee",       location:"Oradea",    area:"16 m²",  duration:"1 zi",   service:"Wall Print UV",      tags:["HoReCa","Cafenea","Artisanal"],           color:"linear-gradient(135deg,#100800,#1a1000,#100800)", accent:"#D97706", h:270, image:"/assets/portofoliu/cafenea-specialty-coffee.png" },
  ...
  { id:12, cat:"textile",     title:"Hanorace festival muzică",       location:"Cluj-Napoca",area:"200 buc",duration:"5 zi", service:"Print Textile",      tags:["Evenimente","Hanorace","Festival"],       color:"linear-gradient(135deg,#00101a,#001525,#00101a)", accent:"#3B82F6", h:310, image:"/assets/portofoliu/hanorace-festival-muzica.png" },
  ...
  // New additions
  { id:23, cat:"commercial",  title:"Restaurant focal — mural art-deco",  location:"Timișoara", area:"22 m²",  duration:"8h",     service:"Wall Print UV",      tags:["HoReCa","Restaurant","Art-Deco"],         color:"linear-gradient(135deg,#1a0a00,#281200,#1a0a00)", accent:"#F97316", h:340, image:"/assets/portofoliu/restaurant-birou-focal.png" },
  { id:24, cat:"commercial",  title:"Sală conferință — branding corporate", location:"Cluj-Napoca", area:"40 m²", duration:"2 zi", service:"Wall Print UV",      tags:["Corporate","Office","Branding"],          color:"linear-gradient(135deg,#000d1a,#001428,#000d1a)", accent:"#3B82F6", h:300, image:"/assets/portofoliu/sala-conferinta-corporate.png" },
  { id:25, cat:"textile",     title:"Polo corporate — hotel & resort",     location:"Timișoara", area:"50 buc", duration:"3 zi",   service:"Print Textile",      tags:["HoReCa","Uniforme","Polo"],               color:"linear-gradient(135deg,#001a08,#002510,#001a08)", accent:"#22C55E", h:270, image:"/assets/portofoliu/tricouri-echipa-startup.png" },
  { id:26, cat:"textile",     title:"Uniforme polo — echipă hospitality",  location:"Arad",      area:"40 buc", duration:"3 zi",   service:"Print Textile",      tags:["HoReCa","Uniforme","Polo"],               color:"linear-gradient(135deg,#001020,#001830,#001020)", accent:"#60A5FA", h:260, image:"/assets/portofoliu/tricouri-echipa-startup2.png" },
  { id:27, cat:"custom",      title:"Trofee lemn gravate corporate",       location:"Timișoara", area:"30 buc", duration:"2 zi",   service:"Gravare Laser CO₂",  tags:["Corporate","Trofee","Premium"],           color:"linear-gradient(135deg,#1a1000,#251800,#1a1000)", accent:"#F59E0B", h:280, image:"/assets/portofoliu/trofee-corporate-gravate.png" },
  { id:28, cat:"custom",      title:"Căni ceramică — brandul tău",         location:"Cluj-Napoca",area:"80 buc",duration:"2 zi",  service:"Obiecte Custom",     tags:["Gifting","Căni","Corporate"],             color:"linear-gradient(135deg,#12001a,#1c0028,#12001a)", accent:"#C084FC", h:265, image:"/assets/portofoliu/cani-ceramica-foto-brand.png" },
  { id:29, cat:"custom",      title:"Signalistică directivă — acril",      location:"Timișoara", area:"20 buc", duration:"1 zi",   service:"Gravare Laser CO₂",  tags:["Semnalistică","Acril","Office"],          color:"linear-gradient(135deg,#001020,#001830,#001020)", accent:"#22D3EE", h:310, image:"/assets/portofoliu/signalistica-acril-firma.png" },
  { id:30, cat:"custom",      title:"Print UV pe lemn — geometric v1",     location:"Arad",      area:"6 buc",  duration:"3h",     service:"Obiecte Custom",     tags:["Lemn","Geometric","Modern"],              color:"linear-gradient(135deg,#1a1000,#251800,#1a1000)", accent:"#FB923C", h:290, image:"/assets/portofoliu/print-uv-lemn-geometric.png" },
  { id:31, cat:"custom",      title:"Print UV pe lemn — geometric v2",     location:"Timișoara", area:"8 buc",  duration:"4h",     service:"Obiecte Custom",     tags:["Lemn","Geometric","Modern"],              color:"linear-gradient(135deg,#1a1200,#261a00,#1a1200)", accent:"#FDBA74", h:275, image:"/assets/portofoliu/print-uv-lemn-geometric2.png" },
  { id:32, cat:"custom",      title:"Print UV pe acril — geometric albastru", location:"Timișoara", area:"4 buc", duration:"2h",  service:"Obiecte Custom",     tags:["Acril","Geometric","Premium"],            color:"linear-gradient(135deg,#001828,#002035,#001828)", accent:"#38BDF8", h:260, image:"/assets/portofoliu/print-uv-acril-geometric.png" },
  { id:33, cat:"commercial",  title:"Wall print sală fitness — NO LIMITS", location:"Timișoara", area:"25 m²",  duration:"6h",     service:"Wall Print UV",      tags:["Sport","Fitness","Motivational"],         color:"linear-gradient(135deg,#1a0800,#281000,#1a0800)", accent:"#F97316", h:310, image:"/assets/portofoliu/wall-print-sala-fitness-gantere.png" },
  { id:34, cat:"commercial",  title:"Wall print cabinet stomatologic",     location:"Timișoara", area:"8 m²",   duration:"3h",     service:"Wall Print UV",      tags:["Medical","Cabinet","Educațional"],        color:"linear-gradient(135deg,#001a12,#00261a,#001a12)", accent:"#2DD4BF", h:330, image:"/assets/portofoliu/wall-print-clinica-stomatologica-dinte.png" },
  { id:35, cat:"commercial",  title:"Wall print salon beauty — floral",    location:"Arad",      area:"12 m²",  duration:"4h",     service:"Wall Print UV",      tags:["Beauty","Salon","Floral"],                color:"linear-gradient(135deg,#1a0010,#260018,#1a0010)", accent:"#F472B6", h:350, image:"/assets/portofoliu/wall-print-salon-beauty-floral-elegant.png" },
];
