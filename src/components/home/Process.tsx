...
export default function Process() {
  ...
  return (
    <section
      ...
      style={{
        padding: "96px 40px",
        background: "radial-gradient(ellipse 70% 50% at 50% 100%, rgba(249,115,22,0.17) 0%, transparent 65%), radial-gradient(ellipse 40% 30% at 50% 0%, rgba(249,115,22,0.09) 0%, transparent 55%)",
      }}
    >
