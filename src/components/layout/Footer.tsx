...
const COLS = [
  ...
  { title: "Info", links: [{ label: "Portofoliu", href: "/portofoliu" }, { label: "Before / After", href: "/before-after" }, { label: "Despre Noi", href: "/despre-noi" }, { label: "Contact", href: "/contact" }, { label: "Pregătire fișiere", href: "#" }] },
  { title: "Legal", links: [{ label: "Termeni și condiții", href: "#" }, { label: "Politică confidențialitate", href: "#" }, { label: "Politică cookies", href: "#" }, { label: "ANPC", href: "#" }] },
];
