...
export default function MobileBar() {
  return (
    <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 98, background: "rgba(20,20,20,.97)", backdropFilter: "blur(12px)", borderTop: "1px solid var(--bg-border)", display: "flex", gap: 8, padding: 10 }}>
      {BUTTONS.map((b) => (
