...
export default function ServiciiMainServices() {
  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} className="resp-px" style={{ padding: "0 40px 80px", maxWidth: 1200, margin: "0 auto", background: "radial-gradient(ellipse 55% 60% at 0% 100%, rgba(249,115,22,0.14) 0%, transparent 60%), radial-gradient(ellipse 40% 50% at 100% 0%, rgba(249,115,22,0.09) 0%, transparent 55%)" }}>
