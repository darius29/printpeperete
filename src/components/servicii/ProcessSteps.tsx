...
export default function ProcessSteps() {
  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} className="resp-section-80" style={{ padding: "80px 40px", background: "radial-gradient(ellipse 70% 50% at 50% 50%, rgba(249,115,22,0.14) 0%, transparent 65%), radial-gradient(ellipse 30% 50% at 100% 100%, rgba(249,115,22,0.09) 0%, transparent 55%)" }}>
