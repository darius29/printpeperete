  ...
  return (
    <section className="hero-pad-xl" style={{ position: "relative", padding: "140px 40px 80px", overflow: "hidden" }}>
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        <Image
          src="/assets/hero/print-uv-direct-perete-atelier-timisoara-sdg-print.png"
          alt=""
          aria-hidden="true"
          fill
          priority
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "clamp(15px,1.8vw,17px)", color: "var(--text-hero)", lineHeight: 1.75, maxWidth: 560, margin: "0 auto 40px", animation: "fadeUp .9s .3s both" }}>
